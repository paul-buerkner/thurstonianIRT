...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(160, 158, "end", "model_thurstonian_irt_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            size_t Yreal_limit_0__ = ((primitive_value(logical_eq(family,3)) || primitive_value(logical_eq(family,4))) ? N : 0 );
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("gamma", "((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 )", ((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 ));
        context__.validate_dims("initialization", "gamma", "vector_d", context__.to_vec(((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 )));
        vector_d gamma(static_cast<Eigen::VectorXd::Index>(((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 )));
        for (int j1__ = 0U; j1__ < ((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 ); ++j1__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > gamma_ord;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  eta(static_cast<Eigen::VectorXd::Index>(N_person),static_cast<Eigen::VectorXd::Index>(N_trait));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  lambda(static_cast<Eigen::VectorXd::Index>(N_item));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  psi(static_cast<Eigen::VectorXd::Index>(N_item));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  r(static_cast<Eigen::VectorXd::Index>(N_item));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  sum_psi(static_cast<Eigen::VectorXd::Index>(N));
            ...
            if (as_bool(logical_eq(family,1))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(mu, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                stan::model::deep_copy(Phi(((get_base1(mu,n,"mu",1) - get_base1(gamma,get_base1(J_itemC,n,"J_itemC",1),"gamma",1)) / get_base1(sum_psi,n,"sum_psi",1)))), 
                                "assigning variable mu");
                }
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  thres(static_cast<Eigen::VectorXd::Index>((ncat - 1)));
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(mu, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                stan::model::deep_copy(((get_base1(mu,n,"mu",1) - get_base1(gamma,get_base1(J_itemC,n,"J_itemC",1),"gamma",1)) / get_base1(sum_psi,n,"sum_psi",1))), 
                                "assigning variable mu");
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d gamma = in__.vector_constrain(((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 ));
        ...
        vector_d disp = in__.vector_lb_constrain(0,(logical_eq(family,3) ? 1 : 0 ));
            for (int k_0__ = 0; k_0__ < ((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 ); ++k_0__) {
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  Cor_trait(static_cast<Eigen::VectorXd::Index>(N_trait),static_cast<Eigen::VectorXd::Index>(N_trait));
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= ((primitive_value((primitive_value(logical_eq(family,1)) || primitive_value(logical_eq(family,3)))) || primitive_value(logical_eq(family,4))) ? N_itemC : 0 ); ++k_0__) {
