...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(161, 159, "end", "model_thurstonian_irt_model");
    return reader;
}
        ...
        try {
            ...
            if (as_bool(logical_eq(family, 1))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(mu, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                ((get_base1(mu, n, "mu", 1) - get_base1(gamma, get_base1(J_itemC, n, "J_itemC", 1), "gamma", 1)) / get_base1(sum_psi, n, "sum_psi", 1)), 
                                "assigning variable mu");
                }
