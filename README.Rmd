...
to not answer honestly (e.g., personnel selection), but instead respond in a way
...
topic of debate (Bürkner, Schulte, & Holling, 2019) but it is in any case
...
containing 3 items (i.e., triplets) for which we have data of 100 participants:
...
The structure of the data is the same as what we have obtained via 
the `make_TIRT_data` function above and can readily be passed to the model
fitting functions.
